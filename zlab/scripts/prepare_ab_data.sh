...
export KRONOS_DATASET_END_TIME="${KRONOS_DATASET_END_TIME:-2026-02-28}"
export KRONOS_TRAIN_TIME_RANGE="${KRONOS_TRAIN_TIME_RANGE:-2025-06-01,2025-11-30}"
export KRONOS_VAL_TIME_RANGE="${KRONOS_VAL_TIME_RANGE:-2025-12-01,2025-12-31}"
export KRONOS_TEST_TIME_RANGE="${KRONOS_TEST_TIME_RANGE:-2026-01-01,2026-02-28}"
export KRONOS_BACKTEST_TIME_RANGE="${KRONOS_BACKTEST_TIME_RANGE:-2026-01-01,2026-02-28}"
