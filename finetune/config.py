...
class Config:
    ...
    def __init__(self):
        ...
        self.qlib_data_path = "./data/qlib_data/cn_data"
        self.instrument = 'csi300'

        # Overall time range for data loading from Qlib.
        self.dataset_begin_time = "20110101"
        self.dataset_end_time = '20250605'

        # Sliding window parameters for creating samples.
        self.lookback_window = 20  # Number of past time steps for input.
        self.predict_window = 7  # Number of future time steps for prediction.
        self.max_context = 512  # Maximum context length for the model.

        # Features to be used from the raw data.
        self.feature_list = ['open', 'high', 'low', 'close', 'vol', 'amount']
        # Time-based features to be generated.
        self.time_feature_list = ['minute', 'hour', 'weekday', 'day', 'month']
        self.emotion_feature_list = [
        ...
        self.train_time_range = ["2021-09-23", "2024-12-31"]
        self.val_time_range = ["2025-01-01", "2025-08-31"]
        self.test_time_range = ["2025-08-01", "2025-10-01"]
        self.backtest_time_range = ["2024-07-01", "2025-06-05"]

        # TODO: Directory to save the processed, pickled datasets.
        # self.dataset_path = "./data/processed_datasets"
        self.cache_data_path = "../cache_data"
        self.emotion_data_path = "../涨跌停板统计.csv"
        self.dataset_path = "./data/processed_datasets"
        # =================================================================
        ...
        self.save_path = "./outputs/full_new_models1"
        ...
        self.finetuned_tokenizer_path = f"{self.save_path}/{self.tokenizer_save_folder_name}/checkpoints/best_tokenizer"
        ...
        ablation_config = {
            'use_market_moe': True,  # 控制是否使用MarketMoE
            'use_cross_attention': True,  # 控制是否使用跨模态注意力
            'use_dynamic_weights': True,  # 控制是否使用动态权重
            'use_market_embedding': True,  # 控制是否使用市场嵌入
            'use_cross_modal_loss': True  # 控制是否使用跨模态损失
        }
